...
@Component({
  selector: 'app-lista-recepciones2',
  templateUrl: './lista-recepciones2.component.html',
  styleUrls: ['./lista-recepciones2.component.css']
})
export class ListaRecepciones2Component implements OnInit {
