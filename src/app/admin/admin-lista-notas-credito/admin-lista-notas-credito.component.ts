...
@Component({
  selector: 'app-admin-lista-notas-credito',
  templateUrl: './admin-lista-notas-credito.component.html',
  styleUrls: ['./admin-lista-notas-credito.component.css']
})
export class AdminListaNotasCreditoComponent implements OnInit {
  ...
  @ViewChild(DataTableDirective) 
    ...
    this.srv.lista_ventas_nc(datos).subscribe(
       data => {
         // if (data){
           // this.loading = false;
         // }
