...
@Component({
  selector: 'app-lista-ordenes2',
  templateUrl: './lista-ordenes2.component.html',
  styleUrls: ['./lista-ordenes2.component.css']
})
export class ListaOrdenes2Component implements OnInit {
