...
@Component({
  selector: 'app-recepciones2',
  templateUrl: './recepciones2.component.html',
  styleUrls: ['./recepciones2.component.css']
})
export class Recepciones2Component implements OnInit {
...
///////FIN DETALLE VEHICULO///////////
  ...
  test_reenvio(){
    ...
    this.router.navigate(['/admin/recepciones2', datos]);
  }
