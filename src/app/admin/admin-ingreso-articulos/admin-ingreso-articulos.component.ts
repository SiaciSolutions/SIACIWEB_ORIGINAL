...
@Component({
  selector: 'app-admin-ingreso-articulos',
  templateUrl: './admin-ingreso-articulos.component.html',
  styleUrls: ['./admin-ingreso-articulos.component.css']
})
...
export class AdminIngresoArticulosComponent implements OnInit {
