...
@Component({
  selector: 'app-admin-lista-ped-medicos',
  templateUrl: './admin-lista-ped-medicos.component.html',
  styleUrls: ['./admin-lista-ped-medicos.component.css']
})
...
export class AdminListaPedidosMedicosComponent implements OnInit {
  ...
  // public dtTrigger: Subject<any> = new Subject();
   ...
   ngOnInit() {
	...
	this.srv.lista_pedidos_medicos(datos).subscribe(
	   data => {
		   // if (data){
			   // this.loading = false;
		   // }
		...
		this.dtOptions = {
			...
			buttons: [{
                extend: 'print',
                filename: 'LISTA_ORDENES_SIACI_WEB'+this.usuario
            },
            {
                extend: 'excel',
                filename: 'LISTA_ORDENES_SIACI_WEB'+this.usuario
    ...
    render_table(new_list): void {
		...
		setTimeout(()=> {	
			...
			this.dtOptions = {
				...
				buttons: [{
					extend: 'print',
					filename: 'LISTA_ORDENES_SIACI_WEB_'+this.usuario
				},
				{
					extend: 'excel',
					filename: 'LISTA_ORDENES_SIACI_WEB_'+this.usuario
