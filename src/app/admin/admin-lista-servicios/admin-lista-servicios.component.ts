...
@Component({
  selector: 'app-admin-lista-servicios',
  templateUrl: './admin-lista-servicios.component.html',
  styleUrls: ['./admin-lista-servicios.component.css']
})
...
export class AdminListaServiciosComponent implements OnInit {
  ...
  // public dtTrigger: Subject<any> = new Subject();
   ...
   ngOnInit() {
	...
	this.srv.lista_servicios(datos).subscribe(
	   data => {
		   // if (data){
			   // this.loading = false;
		   // }
   ...
   delete_servicio(codser): void {
	...
	datos['codser'] = codser;
		...
		if (confirm("Esta seguro de eliminar este servicio.???")){
			...
			this.srv.eliminar_servicio(datos).subscribe(
			   data => {
				   // if (data){
					   // this.loading = false;
				   // }
				   console.log("########### RESPUESTA ELIMINCACION SERVICIO ###########")
				   console.log(data)
				   // console.log ("EJECUTADA DATA")
				   // data['STATUS'].indexOf("")
