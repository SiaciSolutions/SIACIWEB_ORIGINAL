...
////PARA BUSCAR CIUDAD
	   ...
	   data => {
		   ...
		   for (let csv_json of data) {
			   ...
			   data => {
				...
				// console.log("###### ARRAY DE OBJETOS DE LISTA RENGLONES ##########")
				// console.log (this.lista_renglones)
	...
	// this.srv.reporte_renglones_pedidos_ruta(datos_reporte).subscribe(
	   // data => {
		   // console.log("###### LISTA PRODUCTO  ##########")
		   // console.log(data)
		   
		   
		   // this.tipo_doc_lista = data
		   
		  // setTimeout(()=> {	
			// console.log("TIME OUT")
			// console.log("#### LISTA  ####")
			// console.log(this.tipo_doc_lista)
		// if ((this.tipo_doc_lista) && this.tipo_doc_lista.length > 0){
			// console.log("#### SI HAY INFORMACION ####")
			// this.lista_pedidos = this.tipo_doc_lista
				// this.dtOptions = {
					// order: [1, 'desc'],
					// dom: 'Bfrtip',
					// buttons: ['print','excel'],
