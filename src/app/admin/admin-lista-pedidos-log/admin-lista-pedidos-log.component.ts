...
@Component({
  selector: 'app-admin-lista-pedidos-log',
  templateUrl: './admin-lista-pedidos-log.component.html',
  styleUrls: ['./admin-lista-pedidos-log.component.css']
})

export class AdminListaPedidosLogComponent implements OnInit {
  ...
  // public dtTrigger: Subject<any> = new Subject();
   ...
   ngOnInit() {
	...
	this.srv.lista_pedidos_log(datos).subscribe(
	   data => {
		   // if (data){
			   // this.loading = false;
		   // }
