...
@Component({
  ...
  templateUrl: './admin-lista-transferencias.component.html',
  styleUrls: ['./admin-lista-transferencias.component.css']
})
...
export class AdminListaTranferenciasComponent implements OnInit {
