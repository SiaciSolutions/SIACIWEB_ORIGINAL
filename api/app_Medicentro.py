...
def actualizar_encabezado_pedido():
  ...
  # observ = 'null' if datos['observ'] == None else "'"+datos['observ']+"'"
  datos['observ'] = 'null' if datos['observ'] == None else "'"+datos['observ']+"'"
  sql = "update encabezadopedpro set codcli= '{}',observ={},ciucli='{}',totnet={},iva_cantidad={}, fecult= '{}', fectra= '{}' , codven= '{}' where codemp='{}' and numtra='{}' and tiptra=1".format(datos['codcli'], datos['observ'], datos['ciucli'], datos['totnet'], datos['iva_cantidad'], datos['fecult'], datos['fectra'], datos['codven'], datos['codemp'], datos['numtra'])
  print (sql)
  curs.execute(sql)
  conn.commit()
