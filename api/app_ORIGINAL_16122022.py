...
def lista_ventas_pdv():
  ...
  (select f.autorizacionsri from factura_electronica f where f.idfactura=pv.serie||pv.numfac and tipo_origen = 'PV') as auth,
  (select f.estadodocumento from factura_electronica f where f.idfactura=pv.serie||pv.numfac and tipo_origen = 'PV'),
  pv.conpag,pv.numfac,
   (select f.descripcionerror from factura_electronica f where f.idfactura=pv.serie||pv.numfac and tipo_origen = 'PV'),
