...
def lista_envios_courier():
  ...
  'link_guia_courier','nomdestinatario','nomvhi','nopiezas','peso']
  ...
  if datos['tipacc'] == 'P':
     ...
     ,(select v.nomvhi from vehiculos v where v.codvhi = gc.codvhi and v.codemp=pv.codemp) as nomvhi,gc.nopiezas,gc.peso
    ...
    """.format(datos['codalm'],datos['codemp'],datos['fecha_desde'],datos['fecha_hasta'],datos['courier'],datos['usuario'])
  else:
      sql = """ SELECT pv.faccli,pv.codcli,pv.fecfac,pv.codalm,pv.codusu,pv.totfac,pv.nomcli,pv.numcaj,pv.tiptar,pv.tipche,pv.tipefe,pv.serie,pv.turno,
     (select nomalm from almacenes a1 where a1.codalm=pv.codalm and a1.codemp=pv.codemp),
     (select nomcaj from cajapuntoventa c where c.numcaj=pv.numcaj and c.codemp=pv.codemp),
     ...
     ---and totfac <> 0  
     order by pv.numfac desc
    """.format(datos['codalm'],datos['codemp'],datos['fecha_desde'],datos['fecha_hasta'],datos['courier'])
  ...
  for r in regs:
    ...
    # urlfile = 'http://' + coneccion.ip + ':' + coneccion.puerto + '/images/'
    ticket_file= datos['api_url'] + '/ticket/'+r[21]
    r_salida = (r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10],r[11],r[12],r[13],r[14],r[15],r[16],r[17],'no_existe_auth',r[18],r[19],r[20],ticket_file,r[22],r[23],r[24],r[25],r[26],r[27],r[28],r[29],r[30])
    if (r[15]):
       urlfile = datos['api_url'] + '/pdf_file/'+datos['codemp']+'_'
       pdf = urlfile + r[15] + '.pdf'
       r_salida = (r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10],r[11],r[12],r[13],r[14],r[15],r[16],r[17],pdf,r[18],r[19],r[20],ticket_file,r[22],r[23],r[24],r[25],r[26],r[27],r[28],r[29],r[30])
    d = dict(zip(campos, r_salida))
    # print (d)
    arrresp.append(d)
